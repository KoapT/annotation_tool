...
def ellipse_homo_error(params, object_points_2d, ellipse_params_obs,
                       radii_real):
...
def optimize(ellipse_label):
    ...
    radii_real = np.array(
        [0.009, 0.009, 0.0136, 0.0136, 0.0136, 0.0136, 0.0136]) / 2
    ...
    # 5. 优化
    result = least_squares(ellipse_homo_error,
                           params0,
                           args=(object_points_2d, ellipse_params_init,
                                 radii_real),
                           verbose=2)
    N = len(object_points_2d)
